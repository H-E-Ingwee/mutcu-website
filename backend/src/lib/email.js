...
const FROM_NAME = process.env.MAIL_FROM_NAME || 'MUTCU Website';
const REPLY_TO = process.env.MAIL_REPLY_TO || 'info@mutcu.org';
...
async function sendContactNotification({ name, email, subject, message }) {
  const adminEmail = process.env.ADMIN_EMAIL || 'info@mutcu.org';
  return sendEmail({
    to: adminEmail,
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto">
        <div style="background:linear-gradient(135deg,#04003D,#0a0060);padding:24px 32px">
          <h2 style="color:#FF9700;margin:0;font-size:20px">MUTCU Website — New Contact Message</h2>
        </div>
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto">
        ...
        <div style="padding:32px;background:#fff;text-align:center">
          ...
          <p style="color:#6B7280">You'll receive updates on services, events, devotionals, and ministry opportunities from Murang'a University of Technology Christian Union.</p>
