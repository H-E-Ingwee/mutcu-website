...
const { sendContactNotification, sendEmail } = require('../lib/email')
          ...
          await sendEmail({
            ...
            html: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto">
              <div style="background:linear-gradient(135deg,#04003D,#0a0060);padding:24px 32px">
                <h2 style="color:#FF9700;margin:0">MUTCU — Message Received</h2>
              </div>
              ...
              <div style="background:#f5f7fa;padding:12px 32px;text-align:center;font-size:11px;color:#9CA3AF">
                MUTCU · mutcu.org · mutcunion@gmail.com
              </div>
            </div>`,
          })
        }
      } catch (e) { console.error('[AI] Contact auto-reply failed:', e.message) }
    })()
