...
const SUB_MINISTRIES = [
  {
    ...
    activities: [
      'Setting up and operating sound systems for all services.',
      'Mixing audio for live worship, speakers, and special events.',
      'Maintaining and troubleshooting audio equipment.',
      'Training new sound engineers.',
    ],
  ...
  },
  {
    ...
    activities: [
      'Livestreaming Sunday services and Friday fellowships.',
      'Recording and editing video content for social media.',
      'Managing camera operations during services and events.',
      'Producing video content for the Union\'s digital platforms.',
    ],
    meeting: 'As scheduled — confirmed weekly.',
  },
  {
    icon: 'fa-desktop',
    title: 'Projection & Visuals',
    ...
    activities: [
      'Preparing and displaying song lyrics and scripture slides.',
      'Managing presentation slides for speakers and events.',
      'Operating projection systems during all services.',
      'Creating visual content for services and events.',
    ],
    meeting: 'As scheduled — confirmed weekly.',
  },
  {
    ...
    activities: [
      'Designing posters, banners, and digital content for events.',
      'Managing MUTCU\'s social media accounts (Facebook, Instagram, TikTok, YouTube).',
      'Creating and distributing digital announcements and newsletters.',
      'Maintaining consistent brand identity across all platforms.',
    ],
...
export default function TechnicalDeptPage() {
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionTitle title="Our Technical Sub-Ministries" subtitle="The ministry comprises four specialized sub-committees, each with distinct technical responsibilities." />
